...
This todo CLI app has been made as a part of the CoronaSafe Engineering fellowship!
This command-line (CLI) program lets you manage your todos.

The specification for this problem is written down as tests. All the tests are successfully passing.
...
2. Once installed, execute the todo app by running the following command from the terminal.
